export const cases = {
  ...
  voice_nodule_001: {
    ...
    responseRules: [
      { id:'voice_rest_advice', triggers:['少大聲','不要大聲','減少大聲','聲音休息','休聲','麥克風','擴音'], when:'學生談到減少大聲說話、增加聲音休息、改善下課管理或善用擴音', response:'下課都急著處理學生，有時候真的會不自覺大聲，這個可能要改一下。' },
      { id:'hydration_advice', triggers:['多喝水','增加喝水','補充水分','白開水','水分攝取'], when:'學生建議增加喝水或補充水分', response:'所以是一次要喝很多水嗎？可是我不喜歡喝白開水，可以用咖啡或茶代替嗎？' },
      { id:'throat_clear_advice', triggers:['少清喉嚨','不要清喉嚨','減少清喉嚨','避免清喉嚨'], when:'學生說明應減少清喉嚨', response:'我真的很常不自覺就想清喉嚨，這個習慣可能要慢慢改。' },
      { id:'nodule_explanation', triggers:['聲帶結節是','聲帶長繭是','形成原因','摩擦','碰撞','用聲過度'], when:'學生向病人解釋聲帶結節或形成原因', response:'聲帶長繭以後是不是就不會恢復了？我才教書第二年而已，現在就長繭會不會太快了？' },
