export const cases = {
  ...
  voice_nodule_001: {
    ...
    facts: [
      { id:'residence', label:'居住地', category:'background', value:'我住在台北市中山區。', triggers:['住哪裡','住哪','居住地','哪一區','台北哪裡'], mayVolunteer:false },
      { id:'family_status', label:'家庭狀況', category:'background', value:'我跟家人一起住，目前未婚。', triggers:['跟誰住','家人','家庭狀況','結婚','婚姻','未婚'], mayVolunteer:false },
      { id:'teaching_tenure', label:'任教年資', category:'participation', value:'我當老師大約2年，目前是小學二年級的代課老師兼導師。', triggers:['教幾年','當老師多久','任教多久','年資','代課多久'], mayVolunteer:false },
      { id:'diagnosis', label:'本次診斷與轉介', category:'medical_history', value:'今年12月我再次到耳鼻喉科檢查，醫師說我是雙側聲帶結節，也就是聲帶長繭，叫我來做嗓音評估和衛教，大約兩個月後要回耳鼻喉科複檢。', triggers:['診斷','醫師怎麼說','聲帶結節','長繭','為什麼來','轉介','複檢','十二月','12月'], mayVolunteer:false },
    ...
    rubric: [
      ...
      { id:'voice_education', label:'提供減少嗓音負荷與補充水分等衛教', factIds:[], studentActionTriggers:['建議你多喝水','可以多喝水','要多喝水','增加喝水','補充水分','減少大聲說話','避免大聲說話','不要大聲說話','使用班級麥克風','多用麥克風','讓聲音休息','聲音休息','減少清喉嚨','避免清喉嚨','不要清喉嚨'], points:10, coachHint:'在完成問診後，可依病人的工作與飲水習慣提供具體可行的嗓音保健建議。' },
      { id:'voice_explanation', label:'以病人可理解的方式說明聲帶結節並回應疑問', factIds:[], studentActionTriggers:['聲帶結節通常是','聲帶長繭通常是','可能跟反覆摩擦有關','可能跟反覆碰撞有關','可能跟用聲過度有關','可能跟過度用聲有關','長期大聲說話可能'], points:5, coachHint:'可用非專業術語解釋可能原因，並回應病人對恢復與職業用聲的疑問。' }
    ]
  }
};
